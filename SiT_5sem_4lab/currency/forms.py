...
class CurrencyForm(forms.Form):
    source_currency_value = forms.DecimalField(label='Сумма')
    source_currency_code = forms.CharField(label='Из', widget=forms.Select(choices=INTEGER_CHOICES))
    target_currency_code = forms.CharField(label='В', widget=forms.Select(choices=INTEGER_CHOICES))
